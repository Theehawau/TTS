...
SAVE_DIR=/l/users/speech_lab/_SpeechT5PretrainDataset/Finetune/TTS/models/$DATASET
TRAIN_SET=train
VALID_SET=valid
...
PT_CHECKPOINT_PATH=/l/users/speech_lab/_SpeechT5PretrainDataset/Finetune/TTS/models/MGB2/checkpoint_best.pt
# WANDB_PROJECT=tts-mgb
